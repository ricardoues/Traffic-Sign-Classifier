...
As a first step, I decided to convert the images to grayscale because the color is not relevant in order to identify the traffic sign. Here is an example of a traffic sign image before and after grayscaling.
